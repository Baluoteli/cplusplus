...
BOOL CAgoraCameraManager::GetCurDeviceID(char* szDeviceID)
{
//	CString		str;
...
BOOL CAgoraCameraManager::GetDevice(UINT nIndex, char *rDeviceName, char *rDeviceID)
{
...
//	ASSERT(nIndex < GetDeviceCount())
	...
	memcpy(rDeviceName, szDeviceName,MAX_DEVICE_ID_LENGTH);
	memcpy(rDeviceID, szDeviceID,MAX_DEVICE_ID_LENGTH);
...
BOOL CAgoraCameraManager::SetCurDevice(char* lpDeviceID)
{
